		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Pratica Model 1 ADS",
									"targetURL": "#mentoriafiorikapraticamodel1ads-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoriafiorikapraticamodel1ads-display": {
								"semanticObject": "mentoriafiorikapraticamodel1ads",
								"action": "display",
								"description": "Pratica Model 1 ADS",
								"title": "Pratica Model 1 ADS",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoria.fiori.ka.praticamodel1ads",
									"url": sap.ui.require.toUrl("mentoria/fiori/ka/praticamodel1ads")
								}
							}
						}
					}
